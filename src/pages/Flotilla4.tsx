...
const Flotilla4: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Gráfica 1 - Mantenimientos Realizados (Línea)
    const ctx1 = document.getElementById('settingsChart1') as HTMLCanvasElement;
    if (ctx1) {
    ...
    // Gráfica 2 - Costos de Mantenimiento (Barras)
    const ctx2 = document.getElementById('settingsChart2') as HTMLCanvasElement;
    if (ctx2) {
      charts.push(new Chart(ctx2, {
        type: 'bar',
        data: {
          labels: ['Preventivo', 'Correctivo', 'Emergencia', 'Revisión', 'Actualización'],
          datasets: [{
    ...
    const ctx3 = document.getElementById('settingsChart3') as HTMLCanvasElement;
    if (ctx3) {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-3xl font-bold text-gray-900">Configuración - Flotilla 4</h1>
            </div>
            <button
              onClick={() => navigate('/')}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm chart-wrapper">
              ...
              <div className="chart-container">
                <canvas id="settingsChart1"></canvas>
              </div>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm chart-wrapper">
              ...
              <div className="chart-container">
                <canvas id="settingsChart2"></canvas>
              </div>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm chart-wrapper">
              ...
              <div className="chart-container">
                <canvas id="settingsChart3"></canvas>
              </div>
            </div>
          </div>
        </div>
